...
export default function CreateChild({ entityTypes, parent, entityTypeId }) {
    ...
    return (
        <AppLayout title="Create Child Entity - EAV">
                    ...
                    <div className="bg-white shadow rounded-lg">
                        ...
                        <div className="px-4 py-5 sm:p-6 border-b border-gray-200">
                            <div className="flex items-center space-x-4">
                                <Link
                                    href={route('hierarchy.index')}
                                    className="text-gray-400 hover:text-gray-600"
                                >
                                    <ArrowLeftIcon className="h-6 w-6" />
                                </Link>
                                <div>
                                    <h1 className="text-2xl font-bold text-gray-900">Create Child Entity</h1>
                                    <p className="mt-1 text-sm text-gray-500">
                                        Add a child entity under: {parent?.entity_name}
                                    </p>
                                </div>
                            </div>
                            ...
                            {parent && (
                                <div className="mt-4 p-4 bg-blue-50 rounded-lg">
                                    <div className="flex items-center space-x-3">
                                        ...
                                        <div>
                                            <div className="font-medium text-gray-900">{parent.entity_name}</div>
                                            <div className="text-sm text-gray-500">
                                                {parent.entity_code} • {parent.entity_type?.type_name}
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <form onSubmit={handleSubmit} className="px-4 py-5 sm:p-6">
                            ...
                            <div className="mt-6 flex justify-end space-x-3">
                                ...
                                >
                                    {processing ? 'Đang tạo...' : 'Tạo Child Entity'}
                                </button>
                            </div>
                        </form>
                    </div>
