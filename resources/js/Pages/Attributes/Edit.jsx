...
export default function Edit({ attribute, entityTypes, attributeGroups }) {
    const [selectedEntityType, setSelectedEntityType] = useState(attribute.entity_type_id || '');
    ...
    const { data, setData, put, processing, errors, reset } = useForm({
        ...
        frontend_input: attribute.frontend_input || 'text',
        ...
        max_file_count: attribute.max_file_count || 1,
        ...
        is_user_defined: attribute.is_user_defined || true,
        options: attribute.options || []
    });

    const handleSubmit = (e) => {
        e.preventDefault();
        put(route('attributes.update', attribute.attribute_id), {
            onSuccess: () => {
                // Handle success
            }
        });
    ...
    return (
        <AppLayout title="Edit Attribute - EAV">
                            ...
                            <div className="flex items-center space-x-4">
                                ...
                                <div>
                                    ...
                                    <p className="mt-1 text-sm text-gray-500">
                                        Update attribute: {attribute.attribute_label}
                                    </p>
                                </div>
                            </div>
                        </div>
